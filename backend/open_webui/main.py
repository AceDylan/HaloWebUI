...
async def lifespan(app: FastAPI):
    ...
    # Bookmark Hub embed: check in the background that the Hub accepts our
    # shared secret, so the /hub page can explain a misconfiguration.
    from open_webui.utils.hub_embed import startup_handshake

    asyncio.create_task(startup_handshake())
...
app.state.config.USER_AGENT_CLAUDE = USER_AGENT_CLAUDE
app.state.config.USER_AGENT_GPT = USER_AGENT_GPT
app.state.config.USER_AGENT_GEMINI = USER_AGENT_GEMINI
...
app.state.config.IMAGES_MODEL_CAPABILITY_OVERRIDES = IMAGES_MODEL_CAPABILITY_OVERRIDES
...
app.state.config.AUTO_WEB_SEARCH_DECISION_USE_MAIN_MODEL = (
    AUTO_WEB_SEARCH_DECISION_USE_MAIN_MODEL
)
app.state.config.ENABLE_AUTOCOMPLETE_GENERATION = ENABLE_AUTOCOMPLETE_GENERATION
app.state.config.ENABLE_TAGS_GENERATION = ENABLE_TAGS_GENERATION
app.state.config.ENABLE_TITLE_GENERATION = ENABLE_TITLE_GENERATION
app.state.config.ENABLE_FOLDER_AUTO_ASSIGNMENT = ENABLE_FOLDER_AUTO_ASSIGNMENT


app.state.config.TITLE_GENERATION_PROMPT_TEMPLATE = TITLE_GENERATION_PROMPT_TEMPLATE
app.state.config.TAGS_GENERATION_PROMPT_TEMPLATE = TAGS_GENERATION_PROMPT_TEMPLATE
app.state.config.FOLDER_AUTO_ASSIGNMENT_PROMPT_TEMPLATE = (
    FOLDER_AUTO_ASSIGNMENT_PROMPT_TEMPLATE
)
...
def _hub_embed_config() -> dict:
    from open_webui.utils.hub_embed import hub_url
                ...
                **(
                    {
                        ...
                        # Bookmark Hub embed (/hub): admins only, because the
                        # embed signs them into the Hub as its administrator.
                        "hub_embed": _hub_embed_config(),
                    }
                    if user.role == "admin"
                    else {}
                ),

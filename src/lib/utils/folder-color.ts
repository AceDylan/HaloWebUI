...
const FOLDER_COLORS = [
	{ dot: 'bg-sky-500', text: 'text-sky-500 dark:text-sky-400' },
	{ dot: 'bg-emerald-500', text: 'text-emerald-500 dark:text-emerald-400' },
	...
	{ dot: 'bg-teal-500', text: 'text-teal-500 dark:text-teal-400' },
 ...
 * so up to eight folders never share one and adding a folder does not recolour
